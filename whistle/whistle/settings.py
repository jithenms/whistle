...
REDBEAT_KEY_PREFIX = "whistle:schedule"
...
KMS_PERSONAL_DATA_KEY_ARN = os.getenv("KMS_PERSONAL_DATA_KEY_ARN")
KMS_API_CREDENTIALS_KEY_ARN = os.getenv("KMS_API_CREDENTIALS_KEY_ARN")
KMS_CACHE_CAPACITY = 1000

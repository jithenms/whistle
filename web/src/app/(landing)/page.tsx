...
export default function Home() {
  return (
    <div className="flex bg-zinc-950 items-center justify-center w-screen h-screen">
      <PinContainer title="<NotificationInbox />">
        <div className="bg-white flex flex-col border rounded-xl min-w-max">
          <div className="flex px-4 pt-4 justify-between">
            <p className="font-semibold">Notifications</p>
            <p className="text-gray-500 text-sm">Mark all as read</p>
          </div>
          <div className="flex gap-36 border-t items-center justify-between bg-gray-100 mt-4 px-4 py-3">
            <div className="flex gap-2">
              ...
              <div>
                <p className="text-sm text-gray-500">
                  <span className="font-semibold text-black">@jithenms</span>{" "}
                  sent you a message
                </p>
          ...
          <div className="flex border-t items-center justify-between bg-gray-100 px-4 py-3">
            <div className="flex gap-2">
              <Avatar>
              ...
              <div>
                <p className="text-sm text-gray-500">
                  <span className="font-semibold text-black">@armank</span>{" "}
                  added you to{" "}
          ...
          <div className="flex border-t items-center justify-between px-4 py-3 rounded-b-xl">
            <div className="flex gap-2">
          ...
          <div className="flex border-t items-center justify-between px-4 py-3">
            <div className="flex gap-2">
              <Avatar>
